...
"""
bla="""
trajectory = [(0.0, 0.0, 0.6, -90), #middle
              (0.5, 0.0, 0.6, -90), # 0.5
              (-0.5, 0.0, 0.6, -90), # 1
              (1.0, 0.0, 0.6, -90), # 1.5
              (-1.0, 0.0, 0.6, -90), # 2
...
trajectory = [(0.0, 0.0, 0.75, -75),(1.0, 0.0, 0.75, -75),(-1.0, 0.0, 0.75, -75)]



trajectory = [
(0.0, 0.0, a, y), #left right
(-0.25, 0.0, a, y),
(0.25, 0.0, a, y),
(-0.5, 0.0, a, y),
(0.5, 0.0, a, y),
